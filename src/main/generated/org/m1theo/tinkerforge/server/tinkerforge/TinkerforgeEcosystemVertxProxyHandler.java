...
public class TinkerforgeEcosystemVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final TinkerforgeEcosystem service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public TinkerforgeEcosystemVertxProxyHandler(Vertx vertx, TinkerforgeEcosystem service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public TinkerforgeEcosystemVertxProxyHandler(Vertx vertx, TinkerforgeEcosystem service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public TinkerforgeEcosystemVertxProxyHandler(Vertx vertx, TinkerforgeEcosystem service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
